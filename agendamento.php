    ...
    <section class="inner-page">
      ...
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-in">  Agendamento </h2>
            <p> Seja bem vindo, o agendamento no site é só para avaliações e somente após a avaliação, que serão marcados os procedimentos e próximos atendimentos! </p>
        </div>
            ...
            <div class="col-lg-12">                        
              <div class="form-row">
                <div class="col-md-6 form-group">
                  <input type="text" name="nome" class="form-control" id="nome" placeholder="Insira seu nome" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                  <div class="validate"></div>
                </div>
                <div class="col-md-6 form-group">
                  <input type="email" class="form-control" name="email" id="email" placeholder="Insira seu e-mail" data-rule="email" data-msg="Insira um e-mail válido" />
                  <div class="validate"></div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <input type="time" min="09:00" max="21:00" class="form-control" name="hora" id="hora" placeholder="Insira um horário" />
                <div class="validate"></div>
              </div>
                        
                 <div class="form-group">
                <input type="text" class="form-control" name="telefone" id="telefone" placeholder="Insira seu telefone" />
                <div class="validate"></div>
              </div>
