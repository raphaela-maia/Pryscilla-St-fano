    ...
    <section class="inner-page">
      ...
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-in"> Página de Gerenciamento </h2>
        </div>
          <center>
...
use classes\Consulta;
include_once getcwd(). "../../classes/classes/Consulta.class.php";
include_once getcwd(). "../../classes/classes/ConsultaDAO.class.php";

include_once "paginas/listagem.php";
...
<table><tr>
      <div class="container" data-aos="fade-up">
       ...
       <th width="50%"> <div class="row  justify-content-center">
          ...
          <center><a href="cadastro.php"> Cadastro </a></center>         
