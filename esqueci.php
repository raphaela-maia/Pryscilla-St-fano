    ...
    <section class="breadcrumbs">
      ...
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-in"> Esqueci a senha </h2>
        </div>
...
<div id="frmDiv">
	...
	<input type="button" onclick="funcao1()" class="button" id="btnSendFrmLogin" value="Enviar"> 
...
<table><tr>
      ...
      <div class="credits">
       ...
       <br/> <div class="credits"><a class="linkrodape" href="login.php"> Login </a></div>
    </div>  
  </footer>
</body>
</html>